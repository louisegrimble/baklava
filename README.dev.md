...
git clone git@github.com:louisegrimble/baklava .
...
Don't forget to also make a [release on GitHub](https://github.com/louisegrimble/baklava/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.